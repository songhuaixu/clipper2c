...
#ifdef USINGZ
void clipper_clipper64_set_z_callback(ClipperClipper64 *c, ClipperZCallback64 cb) {
  from_c(c)->SetZCallback([cb](const Point64 &p1, const Point64 &p2,
                               const Point64 &p3, const Point64 &p4,
                               Point64 &p5) {
    cb(reinterpret_cast<const ClipperPoint64 *>(&p1),
